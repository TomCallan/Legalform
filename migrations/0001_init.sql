-- Baseline schema for Signful SaaS (fresh databases).
-- For existing databases created before this file, see 0002_saas_auth.sql.
-- Apply: npx wrangler d1 execute legalform-db --remote --file=migrations/0001_init.sql
